  ...
  `;render(){if(!this._open)return html``;const{title:e,dismissable:t,styles:s}=this._opts;return html`
      ...
      >
        ...
        >
          ...
          <div class="body" style=${styleMap({...DEFAULT_BODY_STYLES,padding:"panel"===this._view?.viewConfig?.type?"4px 24px 24px 24px":"0px 0px 0px 0px",...s.body})}>
