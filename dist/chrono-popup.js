  ...
  `;render(){if(!this._open)return html``;const{title:e,dismissable:t,styles:s}=this._opts;return html`
      ...
      >
        ...
        >
          ...
          <div class="body" style=${styleMap({...DEFAULT_BODY_STYLES,padding:LAYOUT_PADDING_BY_TYPE[this._view?.viewConfig?.type]??"0px 0px 12px 0px",...s.body})}>
